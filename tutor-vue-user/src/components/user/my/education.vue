<template>
  ...
  <div>
    <el-alert style="background-color: #409EFF; color: #f0f2f5; font-style: unset; margin-top: 10px; margin-bottom: 20px" :closable="false" title="教育经历"  />
    <el-button type="primary" @click="dialogFormVisible = true"><i class="el-icon-circle-plus-outline"></i>添加</el-button>
    <el-divider></el-divider>
    <el-dialog title="添加经历" :visible.sync="dialogFormVisible">
      <el-form :model="form">
        <el-form-item label="院校或机构" :label-width="formLabelWidth">
          <el-input v-model="form.e_school" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item label="所学专业" :label-width="formLabelWidth">
          <el-input v-model="form.e_academic" autocomplete="off"></el-input>
        </el-form-item>
        ...
        <el-form-item label="所获荣誉" :label-width="formLabelWidth">
          <el-input type="textarea" v-model="form.e_certificate" autocomplete="off"></el-input>
        </el-form-item>
      </el-form>
      ...
      if(this.form.name != '') {
        this.axios.post(
          '/education/addEducation',
          {
            ...
            e_academic: this.form.e_academic,
            e_start_time: this.form.e_start_time,
            e_end_time: this.form.e_end_time,
            e_certificate: this.form.e_certificate,
          }
        ).then(
          (resp) => {
            if (resp.data == 1) {
